      ...
      <main className="max-w-7xl mx-auto px-4 py-8 space-y-8">
              ...
              >
                <CardContent className="p-4 text-center">
                  <div className="text-3xl mb-2">
                    ...
                    {eventType.value === 'corporate' && '🏢'}
                    {eventType.value === 'kitty-party' && '🎀'}
                    {eventType.value === 'engagement' && '💍'}
                    {eventType.value === 'baby-shower' && '🍼'}
                  </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="outline" size="sm" onClick={() => navigate('/marketplace/events')}>
              View All
            </Button>
          </div>
          {eventsLoading ? (
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="outline" size="sm" onClick={() => navigate('/marketplace/inquiries')}>
              View All
            </Button>
          </div>
          {inquiriesLoading ? (
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  No inquiries yet. Create an event and find vendors!
                </p>
              </CardContent>
            </Card>
          )}
